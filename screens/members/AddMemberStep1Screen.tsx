              ...
              >
                ...
                >
                  {selectedBatch
                    ? `${
                        selectedBatch.name
                      } (${selectedBatch.start_time.substring(
                        0,
                        5,
                      )}–${selectedBatch.end_time.substring(0, 5)})`
                    : 'Select batch'}
                </Text>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          selectedBatch?.id === b.id && styles.pickerItemActive,
                        ]}
                      >
                        {b.name} ({b.start_time.substring(0, 5)}–
                  ...
                  {plans.map(p => (
                    ...
                    >
                      <Text
                        style={[
                          styles.pickerItemText,
                          selectedPlan?.id === p.id && styles.pickerItemActive,
                        ]}
                      >
                        {p.name} — ₹{p.price} / {p.duration_value}{' '}
                        {p.duration_unit}
                      </Text>
                    </TouchableOpacity>
                  ))}
